<template>
  <y-form-model class="select-filed" ref="ruleForm" :model="optionData">
    ...
    <!-- 提示信息 -->
    <TipsConfig :placeholder="false" :strongTips="false" v-model="optionData" />
    ...
    <!-- 操作属性 -->
    <OperationalAttribute :shouChildLabel="true" v-model="optionData" />
  </y-form-model>
</template>
<script>
