<template>
  <y-form-model class="select-filed" ref="ruleForm" :model="optionData">
    ...
    <!-- 内容行高 -->
    <!-- <y-form-model-item label="内容行高">
      <y-input-number style="width: 100%;" :min="0" autoWidth v-model="optionData.rows" placeholder="请输入可视行数" />
    </y-form-model-item> -->
    ...
    <y-form-model-item label="默认值">
      <y-textarea style="width: 100%" autoWidth v-model="optionData.defaultValue" placeholder="请输入默认值" />
    </y-form-model-item>
